...
Personal site. CV at the root, published with GitHub Pages from `main`.
...
```
index.html   CV
style.css    styles, including print
```
...
A pottery page with a gallery layout was built and then removed at commit `411ecf7`. To bring it
back, along with its styles:

```bash
git checkout 411ecf7 -- pottery/index.html
git show 411ecf7:style.css > style.css
```
